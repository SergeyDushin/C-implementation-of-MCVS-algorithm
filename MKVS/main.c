/*This program realizes the improved correlation algorithm.
...
1. EK_start - initialization and first open of the files
2. Real_Signal - makes real EK signals like echo signal, residual echo signal. Also manage the active signal
3. Make_Virtual_Signal - makes service residual echo signal
4. Algorithm_vector - calculates delta H for adaptation
5. Filter_response - adapts pulse response of filter
...
void Get_parameters()
{
 //this function takes parameters from user
...
void EK_start ()
{
 // init the variables and opens the files
